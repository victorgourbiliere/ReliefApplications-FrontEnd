...
export declare class StorageMap {
     ...
     */
    constructor(database: LocalDatabase, jsonValidator?: JSONValidator, LSPrefix?: string, oldPrefix?: string);
    /**
     ...
     */
    readonly backingEngine: 'indexedDB' | 'localStorage' | 'memory' | 'unknown';
    /**
