...
import { InjectionToken, ɵɵdefineInjectable, ɵɵinject, Injectable, Inject, PLATFORM_ID, NgModule } from '@angular/core';
import { isPlatformBrowser } from '@angular/common';
import { ReplaySubject, race, fromEvent, throwError, of, Observable, asyncScheduler, from } from 'rxjs';
import { mergeMap, first, takeWhile, map, tap, observeOn, catchError, mapTo, toArray } from 'rxjs/operators';
 ...
 */
const DEFAULT_IDB_NO_WRAP = false;
/**
...
IndexedDBDatabase.ngInjectableDef = ɵɵdefineInjectable({ factory: function IndexedDBDatabase_Factory() { return new IndexedDBDatabase(ɵɵinject(IDB_DB_NAME), ɵɵinject(IDB_STORE_NAME), ɵɵinject(IDB_DB_VERSION), ɵɵinject(IDB_NO_WRAP), ɵɵinject(LOCAL_STORAGE_PREFIX)); }, token: IndexedDBDatabase, providedIn: "root" });
IndexedDBDatabase = __decorate([
    ...
    __param(4, Inject(LOCAL_STORAGE_PREFIX)),
...
LocalStorageDatabase.ngInjectableDef = ɵɵdefineInjectable({ factory: function LocalStorageDatabase_Factory() { return new LocalStorageDatabase(ɵɵinject(LS_PREFIX), ɵɵinject(LOCAL_STORAGE_PREFIX)); }, token: LocalStorageDatabase, providedIn: "root" });
LocalStorageDatabase = __decorate([
    Injectable({
        providedIn: 'root'
    }),
    __param(0, Inject(LS_PREFIX)),
    __param(1, Inject(LOCAL_STORAGE_PREFIX)),
...
MemoryDatabase.ngInjectableDef = ɵɵdefineInjectable({ factory: function MemoryDatabase_Factory() { return new MemoryDatabase(); }, token: MemoryDatabase, providedIn: "root" });
...
LocalDatabase.ngInjectableDef = ɵɵdefineInjectable({ factory: function LocalDatabase_Factory() { return localDatabaseFactory(ɵɵinject(PLATFORM_ID), ɵɵinject(LS_PREFIX), ɵɵinject(IDB_DB_NAME), ɵɵinject(IDB_STORE_NAME), ɵɵinject(IDB_DB_VERSION), ɵɵinject(IDB_NO_WRAP), ɵɵinject(LOCAL_STORAGE_PREFIX)); }, token: LocalDatabase, providedIn: "root" });
...
JSONValidator.ngInjectableDef = ɵɵdefineInjectable({ factory: function JSONValidator_Factory() { return new JSONValidator(); }, token: JSONValidator, providedIn: "root" });
...
StorageMap.ngInjectableDef = ɵɵdefineInjectable({ factory: function StorageMap_Factory() { return new StorageMap(ɵɵinject(LocalDatabase), ɵɵinject(JSONValidator), ɵɵinject(LS_PREFIX), ɵɵinject(LOCAL_STORAGE_PREFIX)); }, token: StorageMap, providedIn: "root" });
StorageMap = __decorate([
    Injectable({
        providedIn: 'root'
    }),
    __param(2, Inject(LS_PREFIX)),
    __param(3, Inject(LOCAL_STORAGE_PREFIX)),
    __metadata("design:paramtypes", [LocalDatabase,
...
LocalStorage.ngInjectableDef = ɵɵdefineInjectable({ factory: function LocalStorage_Factory() { return new LocalStorage(ɵɵinject(StorageMap)); }, token: LocalStorage, providedIn: "root" });
LocalStorage = __decorate([
    Injectable({
        providedIn: 'root'
    }),
    __metadata("design:paramtypes", [StorageMap])
], LocalStorage);
...
export { JSONValidator, LOCAL_STORAGE_PREFIX, LocalDatabase, LocalStorage, SERIALIZATION_ERROR, SerializationError, StorageMap, StorageModule, VALIDATION_ERROR, ValidationError, localStorageProviders, LS_PREFIX as ɵa, IDB_DB_NAME as ɵb, IDB_DB_VERSION as ɵc, IDB_STORE_NAME as ɵd, IDB_NO_WRAP as ɵe };
